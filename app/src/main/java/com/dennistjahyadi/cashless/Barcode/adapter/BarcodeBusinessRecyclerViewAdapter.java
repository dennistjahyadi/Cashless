...
public class BarcodeBusinessRecyclerViewAdapter extends RecyclerView.Adapter<BarcodeBusinessRecyclerViewAdapter.MyViewHolder> {
    ...
    public BarcodeBusinessRecyclerViewAdapter(List<BarcodeBusiness> sourceMapList, Context context) {
