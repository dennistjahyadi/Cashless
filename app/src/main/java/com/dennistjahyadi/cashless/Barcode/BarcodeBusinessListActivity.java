...
import com.dennistjahyadi.cashless.Barcode.adapter.BarcodeBusinessRecyclerViewAdapter;
...
public class BarcodeBusinessListActivity extends AppCompatActivity {
    ...
    private BarcodeBusinessRecyclerViewAdapter adapter;
    ...
    private void init() {
        ...
        tvBtnCreateBarcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), BarcodeBusinessCreateActivity.class);
                startActivityForResult(i, ACTIVITY_RESULT_BUSINESS_CREATE);
            }
        });
        adapter = new BarcodeBusinessRecyclerViewAdapter(sourceMapList, this);
