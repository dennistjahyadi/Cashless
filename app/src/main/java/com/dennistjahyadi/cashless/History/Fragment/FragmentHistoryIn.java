...
public class FragmentHistoryIn extends Fragment {
    ...
    private void init(View view) {
        ...
        adapter = new HistoryRecyclerViewAdapter(this.historyTransactionList, "in", getContext());
        ...
        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                fetchInHistoryTransaction(totalItemsCount);
            }
        });
        fetchInHistoryTransaction(0);
    }

    private void fetchInHistoryTransaction(int offset) {
        ...
        Call<List<HistoryTransaction>> call = service.fetchInHistoryTransaction(userId, offset, "a");
