...
public class FragmentHistoryOut extends Fragment {
    ...
    private void init(View view) {
        ...
        adapter = new HistoryRecyclerViewAdapter(this.historyTransactionList, "out", getContext());
        ...
        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                fetchOutHistoryTransaction(totalItemsCount);
            }
        });
        fetchOutHistoryTransaction(0);
    }

    private void fetchOutHistoryTransaction(int offset) {
        ...
        Call<List<HistoryTransaction>> call = service.fetchOutHistoryTransaction(userId, offset, "a");
